...
public class ReleaseSpecificParameters {
    ...
    public static final String APICURITO_CURRENT_VERSION = "7.10.0";
    ...
    public static final String OLD_OPERATOR_URL = "registry-proxy.engineering.redhat.com/rh-osbs/fuse7-fuse-apicurito-rhel8-operator:1.9-15";
    //GA image
